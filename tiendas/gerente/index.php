...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <!-- ASIDE MENÚ LATERAL INICIO  -->
    <?php  require_once "../componentes/asideGerente.php";?>
    <!-- ASIDE MENÚ LATELAR FIN -->

    <main class="main-content position-relative border-radius-lg ">
        <!-- Navbar -->
        <?php require_once "../componentes/navbarSuperior.php";  ?>
        <!-- End Navbar -->
                    ...
                    <div class="card ">
                        <div class="card-header pb-0 p-3">
                            <div class="d-flex justify-content-between">
                                <h6 class="mb-2">Ventas por Empleado</h6>
                            </div>
                        </div>
        ...
        <div class="card shadow-lg">
            <div class="card-header pb-0 pt-3 ">
                <div class="float-start">
                    <h5 class="mt-3 mb-0">Configurador de Béoro</h5>
